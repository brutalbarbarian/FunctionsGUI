...
public class IOUtils {
	...
	public static String getAbsolutePath(String root, String relativePath) {
		...
		return CollectionUtils.CollapseStringList(res, File.separator);
	}
	...
	public static void storeMap (Map<?, ?> map, String sep, String nullValue, 
		...
		Files.write(path, CollectionUtils.getIterable(
				CollectionUtils.getMapIterator(map, sep, nullValue)), cs, options);
	}
}
